...
public class MainFrame extends JFrame {
    ...
    public MainFrame() {
// Вызов конструктора предка Framesuper("Построение графиков функций на основе заранееподготовленных файлов");
...
// Создать действие по открытию файла
        Action openGraphicsAction = new AbstractAction("Добавить новый график") {
...
// по аналогии с showAxisMenuItem
        ...
        Action rotate = new AbstractAction("Повернуть на 90") {
            public void actionPerformed(ActionEvent event) {
// по аналогии с showAxisMenuItem
                display.Rotate();
            }
